...
<div class="container mt-3">
    <div class="align-option w-100 mb-3">
        <a type="button" class="text-decoration-none pr-2"
            style="font-weight:<?= $_SESSION["lang"] == "pt" ? "bold" : "normal" ?>;"
            onclick="confirmChange('pt')">PT</a>
        <a type="button" class="text-decoration-none"
            style="font-weight: <?= $_SESSION["lang"] == "en" ? "bold" : "normal" ?>;"
            onclick="confirmChange('en')">EN</a>
